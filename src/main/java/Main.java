...
public class Main {
    ...
    public static void emAAAlgorit() {
...
//        }
        ...
        // print results
        printEmAAAlgoritResults(ticker, prices, performance, probabilities_of_ups, dates, hours);


    }

    public static void printEmAAAlgoritResults
            (String ticker, String [][] prices, char [][] performance, double [] probabilitiesOfUps, String [] dates, String [] hours) {

        String filename = "chart.csv";
        ...
        for (int i = 0; i < dates.length; i++) {
            ...
            for (int j = 0; j < INTERVAL_COUNT + 1; j++) {
                System.out.printf("%1s", " ");
                System.out.printf("%13s", prices[i][j]);

                pw.print(j == INTERVAL_COUNT ? prices[i][j] : prices[i][j] + ",");
                pw.flush();

                System.out.printf("%1s", " ");
                if (j != INTERVAL_COUNT)
                System.out.printf("%10s", performance[i][j]);
            }
            System.out.println();
        ...
        for (int i = 0; i < probabilitiesOfUps.length; i++) {
            System.out.printf("%14s", " ");
            System.out.printf("%11f", probabilitiesOfUps[i]);
        }
        System.out.println();
    }
